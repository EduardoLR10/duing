...
i.e., the ones that will addressed it.

In contrast with languages like Haskell, Rust, and SML, this is addressed directly between the ones that will use the reusable piece of code and the required constraints.
