...
For me, this decision brings great points to the table: first it will allow us to understand better a paradigm that competes with FP, and second it will
...
that the only connection being expressed between the function and whatever you want to deserialize is a contraint which forces you that this value must have
