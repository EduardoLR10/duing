...
it is our job to address this problem of error messages --- it is not a problem with the idea of having a partner to help you explore a jungle of errors.
...
A great idea/model is not bad because its /implementation/ in the real world is bad. It is a human struggle, in all general senses, to have great ideas and models that
