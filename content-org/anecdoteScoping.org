...
the thing that is the same regardless of the instance you are currently
holding, is to [[file:../generalistspecialist/][discover it in an unexpected place]]. Everything else changed, all
...
The qualit- without-a-name's major quirk is peculiar. Some people claim they are able to /identify/ it,
